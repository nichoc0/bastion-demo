...
import { SquaresFour, Pulse, ClockCounterClockwise, TreeStructure, Trophy, ShieldCheck, GearSix, List, X } from '@phosphor-icons/react';
...
const primaryItems = [
    ...
    { id: 'cortex',         label: 'Cortex',         icon: TreeStructure },
...
export function SideNav({ currentView, setCurrentView }) {
    ...
    const visibleNav = primaryItems.filter((i) => (isDev || !INSURANCE_ONLY.has(i.id)) && (i.id !== 'cortex' || demo));
